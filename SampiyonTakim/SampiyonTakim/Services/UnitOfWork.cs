...
using SampiyonTakim.Interfaces;
...
namespace SampiyonTakim.Services
{
    public class UnitOfWork : Interfaces.IUnitOfWork
    {
        ...
        public UnitOfWork(DataContext dataContext)
        {
            ...
            CustomerDemographic = new Services.CustomerDemographicRepository(_dataContext);
        ...
        public ICustomerDemographicRepository CustomerDemographic { get; set; }
